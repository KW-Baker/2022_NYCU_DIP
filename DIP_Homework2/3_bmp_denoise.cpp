...
// Denoise
bool denoise(FILE *fout, RGB** srcImg, int iteration){
	// Start timer
	start_time = clock();
...
int main(){
	...
	// Open bitmap file
	fin  = fopen("./input3.bmp","rb");
	fout1 = fopen("./3_denoise/output3_1.bmp","wb");
	fout2 = fopen("./3_denoise/output3_2.bmp","wb");
	...
	if(fin != NULL){
		...
		cout << "Denoise Start..." << endl << endl;
		
		// 1st denoise
		cout << "[output1] iteration: " << iter1 << endl << endl;
		if(denoise(fout1, img, iter1)){
			cout << endl;
			cout << "Denoise - 1 Success!" << endl;
		}
		else{
			cout << endl;
			cout << "Denoise - 1 Failed!" << endl;
			return 0;
		}	
		...
		if(denoise(fout2, img, iter2)){
			cout << endl;
			cout << "Denoise - 2 Success!" << endl;
		}
		else{
			cout << endl;
			cout << "Denoise - 2 Failed!" << endl;
			return 0;
		}
