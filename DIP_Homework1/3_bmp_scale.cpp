...
bool quanResolution(FILE *fpi, unsigned char quanBit)
{
	...
	if(quanBit == 8)
	{
		if((fpw=fopen("./2_result_quantization/qr_8bit.bmp", "wb"))==NULL)
		{
			cout << "Create the bmp file error!" << endl;
			return false;	
		}
	...
	{
		if((fpw=fopen("./2_result_quantization/qr_7bit.bmp", "wb"))==NULL)
		{
			cout << "Create the bmp file error!" << endl;
			return false;	
		}
	...
	{
		if((fpw=fopen("./2_result_quantization/qr_6bit.bmp", "wb"))==NULL)
		{
			cout << "Create the bmp file error!" << endl;
			return false;	
		}
	...
	{
		if((fpw=fopen("./2_result_quantization/qr_5bit.bmp", "wb"))==NULL)
		{
			cout << "Create the bmp file error!" << endl;
			return false;	
		}
	...
	{
		if((fpw=fopen("./2_result_quantization/qr_4bit.bmp", "wb"))==NULL)
		{
			cout << "Create the bmp file error!" << endl;
			return false;	
		}
	...
	{
		if((fpw=fopen("./2_result_quantization/qr_3bit.bmp", "wb"))==NULL)
		{
			cout << "Create the bmp file error!" << endl;
			return false;	
		}
	...
	{
		if((fpw=fopen("./2_result_quantization/qr_2bit.bmp", "wb"))==NULL)
		{
			cout << "Create the bmp file error!" << endl;
			return false;	
		}
	...
	{
		if((fpw=fopen("./2_result_quantization/qr_1bit.bmp", "wb"))==NULL)
		{
			cout << "Create the bmp file error!" << endl;
			return false;	
		}
	...
	{
		if((fpw=fopen("./2_result_quantization/qr_0bit.bmp", "wb"))==NULL)
		{
			cout << "Create the bmp file error!" << endl;
			return false;
		}
...
bool bilinear_resize(FILE *fpi)
{
	...
	if(mode == "-u" || mode == "-U")
	{
		...
		if(image_num == 1)
		{
			if((fpw = fopen("./3_result_upScaling/output1_up.bmp", "wb")) == NULL)
			{
				cout << "Create the bmp file error!" << endl;
				return false;
			}	
		...
		{
			if((fpw = fopen("./3_result_upScaling/output2_up.bmp", "wb")) == NULL)
			{
				cout << "Create the bmp file error!" << endl;
				return false;
			}		
	...
	else if(mode == "-d" || mode == "-D")
	{
		...
		{
			// Open output bitmap file
			if((fpw = fopen("./4_result_downScaling/output1_down.bmp", "wb")) == NULL)
			{
				cout << "Create the bmp file error!" << endl;
				return false;
			}
		...
		{
			// Open output bitmap file
			if((fpw = fopen("./4_result_downScaling/output2_down.bmp", "wb")) == NULL)
			{
				cout << "Create the bmp file error!" << endl;
				return false;
			}
